...
// // [] = index number of an Array and . = values/objects of an array
// console.log(people[1].address.geo.lat)
people.map(person => delete person.company)
// function (person) {delete person.company}

console.log(people)

// // let person = persons.map (persons => delete persons.company)
// // console.log(person)
// // const itemCompany = persons.map((companies) =>{
...
// //     return accumulator
// // }
// // console.log(removeCompanyFromPerson())
// //
